...
func TestNewNodeService(t *testing.T) {
	...
	service := NewNodeService(nodeID, mockClient, true, registry, 5)
...
func TestNodeGetCapabilities(t *testing.T) {
	service := NewNodeService("test-node", nil, true, nil, 5)
...
func TestNodeGetInfo(t *testing.T) {
	t.Run("with registry", func(t *testing.T) {
		...
		service := NewNodeService(nodeID, nil, true, registry, 5)
	...
	t.Run("without registry", func(t *testing.T) {
		...
		service := NewNodeService(nodeID, nil, true, nil, 5)
...
func TestNodeUnpublishVolume_TestMode(t *testing.T) {
	...
	service := NewNodeService("test-node", nil, true, nil, 5) // testMode=true
	ctx := context.Background()
