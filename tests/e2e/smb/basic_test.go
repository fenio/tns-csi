...
var _ = Describe("SMB Mount and Expansion", func() {
	...
	It("should provision an SMB volume, mount it, perform I/O, and expand it", func() {
		...
		By("Verifying filesystem type is cifs")
		...
		Expect(mountOutput).To(ContainSubstring("cifs"))
